...
void main() {
	...
	`}var Za=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new ws(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Sg={[Zo]:"Linear",[Jo]:"Reinhard",[Ko]:"Cineon",[$o]:"ACESFilmic",[jo]:"AgX",[el]:"Neutral",[Qo]:"Custom"};function bg(i,e){let t=Sg[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var qa=new U;function Tg(){ke.getLuminanceCoefficients(qa);let i=qa.x.toFixed(4),e=qa.y.toFixed(4),t=qa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var Dg={[Ps]:"SHADOWMAP_TYPE_PCF",[Zi]:"SHADOWMAP_TYPE_VSM"};function Ng(i){return Dg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var Ug={[$n]:"ENVMAP_TYPE_CUBE",[gi]:"ENVMAP_TYPE_CUBE",[Ls]:"ENVMAP_TYPE_CUBE_UV"};function Fg(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Ug[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Og={[gi]:"ENVMAP_MODE_REFRACTION"};function Bg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Og[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var zg={[Yo]:"ENVMAP_BLENDING_MULTIPLY",[Qc]:"ENVMAP_BLENDING_MIX",[jc]:"ENVMAP_BLENDING_ADD"};function kg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":zg[i.combine]||"ENVMAP_BLENDING_NONE"}function Vg(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Gg(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=Ng(t),l=Fg(t),u=Bg(t),p=kg(t),h=Vg(t),g=Eg(t),x=wg(r),S=s.createProgram(),m,d,w=t.glslVersion?"#version "+t.glslVersion+`
...
}`;var Et=document.getElementById("view"),Mi=document.getElementById("veil"),Jl=document.getElementById("hud"),ru=document.getElementById("intro"),bn;try{bn=new Ja({canvas:Et,antialias:!1,alpha:!1,depth:!1,stencil:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1})}catch(i){throw Kl("WebGL2 unavailable",String(i.message||i)),i}bn.capabilities.isWebGL2||Kl("WebGL2 unavailable","This scene requires WebGL2.");function Kl(i,e){Mi.classList.add("fail"),Mi.querySelector(".msg-boot").style.display="none",Mi.querySelector(".msg-fail .headline").textContent=i,Mi.querySelector(".msg-fail p").textContent=e||""}var au=bn.getContext(),_0=au.getExtension("EXT_color_buffer_float"),x0=au.getExtension("EXT_color_buffer_half_float"),$s=Qt,lo=1;!_0&&!x0&&($s=bt,lo=.55);function Ti(i,e){return new Yi({vertexShader:Xh,fragmentShader:i,glslVersion:ks,uniforms:e,depthTest:!1,depthWrite:!1,blending:$t})}var ou=new Ms,v0=new mi,lu=new Kt;lu.setAttribute("position",new Dt(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));var $l=new Bt(lu,null);$l.frustumCulled=!1;ou.add($l);function ni(i,e){$l.material=i,bn.setRenderTarget(e),bn.render(ou,v0)}function vi(i,e){return new Nt(i,e,{type:$s,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1,minFilter:gt,magFilter:gt,wrapS:Ht,wrapT:Ht})}function yi(i){i&&i.dispose()}var so=Ti(qh,{uTime:{value:0},uCamPos:{value:new U},uBasis:{value:new Ie},uTanF:{value:1},uAspect:{value:1},uSteps:{value:800},uDtScale:{value:1},uLensing:{value:1},uDoppler:{value:1},uBeamExp:{value:3},uScience:{value:0},uDiskIn:{value:2.6},uTNorm:{value:.354},uGain:{value:1.18},uOpacity:{value:.85},uFlow:{value:.70711},uTwinkle:{value:.6},uTint:{value:new U(1.06,.97,.88)},uJitter:{value:new Fe(0,0)},uStars:{value:1}}),Qa=Ti(Yh,{uCur:{value:null},uPrev:{value:null},uMix:{value:1}}),Gl=Ti(Zh,{uSrc:{value:null},uTexel:{value:new Fe},uThreshold:{value:lo},uKnee:{value:.55}}),Ol=Ti(Jh,{uSrc:{value:null},uTexel:{value:new Fe}}),ii=Ti(Kh,{uSrc:{value:null},uTexel:{value:new Fe},uDir:{value:new Fe(1,0)}}),Bl=Ti($h,{uSrc:{value:null},uTexel:{value:new Fe}}),jh=Ti(Qh,{uScene:{value:null},uB0:{value:null},uB1:{value:null},uB2:{value:null},uB3:{value:null},uB4:{value:null},uStreak:{value:null},uTime:{value:0},uBloomStr:{value:.95},uStreakStr:{value:.34},uExposure:{value:1.05},uSaturation:{value:1.14},uHasGlow:{value:1},uGrainAmt:{value:.03},uPinch:{value:.045},uOutTexel:{value:new Fe(1,1)}}),cu={low:{steps:500,dt:1},medium:{steps:800,dt:1},high:{steps:1100,dt:.85},ultra:{steps:1500,dt:.7}},Ys=["low","medium","high","ultra"],is=[.5,.6,.7,.85,1],Hl={ember:{gain:1.18,doppler:1,sat:1.14,tint:[1.06,.97,.88],bloomStr:.95,streakStr:.34},film:{gain:.96,doppler:.32,sat:.8,tint:[1.05,1,.94],bloomStr:1.1,streakStr:.22}},Qs={orbit:{el:.155,dist:13.5},graze:{el:.03,dist:10.5},overhead:{el:.95,dist:17}},rs=[{label:"STELLAR 10 M",msun:10},{label:"SGR A* 4.3e6",msun:43e5},{label:"GARGANTUA 1e8",msun:1e8}],y0=2.953,Zs=1496e5;function Ql(i){return{rsKm:y0*i,tMaxK:86e5*Math.pow(10/i,.25)}}var fe={quality:"ultra",qKey:"ultra",resScale:1,tierIdx:is.length-1,paused:!1,lensing:!0,doppler:!0,bloom:!0,palette:"ember",scienceMode:!1,massIdx:0,hudHidden:!1},Le={az:.6,el:.55,dist:26,tAz:.6,tEl:Qs.orbit.el,tDist:Qs.orbit.dist,autoBlend:1,idleTimer:0},en=new Rt(63,1,.1,200),it=Object.assign({},Hl.ember,{tint:Hl.ember.tint.slice()}),Pt={gain:0,doppler:0,sat:0,tint:[0,0,0],bloomStr:0,streakStr:0},as=matchMedia("(prefers-reduced-motion: reduce)").matches;as&&(Le.autoBlend=0,fe.quality="medium",fe.qKey="medium",Le.dist=Qs.orbit.dist);var Si=0,bi=9;as&&(Si=bi);var Sn=new Fe,cn=null,ss=null,co=null,Wl=null,Xl=null,Dn=null,Js=null,ql=!0,Nn=[];function eu(i,e){cn=vi(i,e),Wl=vi(i,e),Xl=vi(i,e),Dn=Wl,Js=Xl,ql=!0,ss=vi(i>>1,e>>1),co=vi(i>>1,e>>1),Nn=[];let t=ss.width,n=ss.height;for(let s=0;s<5;s++)t=Math.max(4,t>>1),n=Math.max(4,n>>1),Nn.push({a:vi(t,n),b:vi(t,n)})}var hu=!1;function tr(i){let e=Math.max(8,Math.floor(Sn.x*fe.resScale)),t=Math.max(8,Math.floor(Sn.y*fe.resScale));if(!(!i&&cn&&cn.width===e&&cn.height===t)){tu();try{eu(e,t)}catch(n){if(tu(),$s!==bt){console.warn("Gargantua: HDR targets unavailable, falling back to LDR \u2014",n.message),$s=bt,lo=.55,Gl.uniforms.uThreshold.value=lo;try{eu(e,t);return}catch{}}hu=!0,console.error("Gargantua:",n.message||n),Kl("GPU memory allocation failed","The renderer could not allocate frame buffers at this resolution. Try a smaller window or a device with more GPU memory.")}}}function tu(){yi(cn),yi(ss),yi(co),yi(Wl),yi(Xl),Dn=Js=null;for(let i of Nn)yi(i.a),yi(i.b)}function jl(){bn.setPixelRatio(Math.min(devicePixelRatio||1,du)),bn.setSize(Et.clientWidth||2,Et.clientHeight||2,!1),bn.getDrawingBufferSize(Sn),en.aspect=Sn.x/Math.max(1,Sn.y),en.updateProjectionMatrix()}var zl=null,Yl=0,Zl=0;function uu(){zl===null&&(zl=setTimeout(()=>{zl=null;let i=Et.clientWidth,e=Et.clientHeight,t=Sn.x,n=Sn.y;(i!==Yl||e!==Zl)&&(jl(),Yl=i,Zl=e),(Sn.x!==t||Sn.y!==n)&&tr(!1)},180))}new ResizeObserver(uu).observe(Et);var du=1.75;function fu(){let i=Math.min(devicePixelRatio||1,du);matchMedia(`(resolution: ${i}dppx)`).addEventListener("change",()=>{jl(),Yl=Et.clientWidth,Zl=Et.clientHeight,tr(!1),fu()},{once:!0})}fu();var nu=parseFloat(new URLSearchParams(location.search).get("kiosk")||"0");nu>0&&setTimeout(()=>location.reload(),nu*36e5);var M0=new URLSearchParams(location.search).has("nograin"),S0=new URLSearchParams(location.search).has("nostars"),b0=new URLSearchParams(location.search).has("clean");b0&&Jl.classList.add("hidden");var Ws=new URLSearchParams(location.search).has("metro"),hn=new Map,ro=0;function os(){Le.idleTimer=0}function Ks(){Si<bi&&(Si=bi,Tu())}function js(i,e,t){return Math.min(t,Math.max(e,i))}Et.addEventListener("pointerdown",i=>{if(Et.setPointerCapture(i.pointerId),hn.set(i.pointerId,{x:i.clientX,y:i.clientY}),hn.size===2){let e=[...hn.values()];ro=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}Et.classList.add("dragging"),os(),Ks()});Et.addEventListener("pointermove",i=>{if(!hn.has(i.pointerId))return;let e=hn.get(i.pointerId),t=i.clientX-e.x,n=i.clientY-e.y;if(hn.set(i.pointerId,{x:i.clientX,y:i.clientY}),hn.size===1)Le.tAz-=t*.0042,Le.tEl=js(Le.tEl+n*.0032,-1.35,1.35),os();else if(hn.size===2){let s=[...hn.values()],r=Math.hypot(s[0].x-s[1].x,s[0].y-s[1].y);ro>0&&r>.5&&(Le.tDist=js(Le.tDist*(ro/r),7.5,30)),ro=r,os()}});function pu(i){hn.delete(i.pointerId),hn.size===0&&Et.classList.remove("dragging")}Et.addEventListener("pointerup",pu);Et.addEventListener("pointercancel",pu);Et.addEventListener("wheel",i=>{i.preventDefault(),Le.tDist=js(Le.tDist*Math.exp(i.deltaY*.0011),7.5,30),os(),Ks()},{passive:!1});function ho(i,e,t){document.querySelectorAll(i).forEach(n=>{let s=n.dataset[e]===t;n.classList.toggle("on",s),(e==="pal"||e==="view"||e==="q")&&n.setAttribute("aria-pressed",s)})}document.querySelectorAll(".chip.view").forEach(i=>i.addEventListener("click",()=>ao(i.dataset.view)));document.querySelectorAll(".chip.qual").forEach(i=>i.addEventListener("click",()=>mu(i.dataset.q)));document.querySelectorAll(".chip.pal").forEach(i=>i.addEventListener("click",()=>ec(i.dataset.pal)));document.querySelectorAll(".chip.tog").forEach(i=>i.addEventListener("click",()=>{let e=i.id;e==="btnLens"&&gu(!fe.lensing),e==="btnDopp"&&xu(!fe.doppler),e==="btnBloom"&&vu(!fe.bloom)}));document.getElementById("btnPause").addEventListener("click",yu);document.getElementById("btnHelp").addEventListener("click",Su);document.getElementById("btnSci").addEventListener("click",()=>tc(!fe.scienceMode));document.getElementById("btnMass").addEventListener("click",_u);function ao(i){Le.tEl=Qs[i].el,Le.tDist=Qs[i].dist,ho(".chip.view","view",i),os()}function mu(i){fe.quality!==i&&(fe.quality=i,fe.qKey=i==="auto"?"medium":i,fe.tierIdx=is.length-1,fe.resScale=is[fe.tierIdx],ho(".chip.qual","q",i),tr(!1))}function T0(){let i=["auto",...Ys],e=i[(i.indexOf(fe.quality)+1)%i.length];mu(e)}function ec(i){fe.palette=i;let e=Hl[i];Pt.gain=e.gain,Pt.doppler=e.doppler,Pt.sat=e.sat,Pt.bloomStr=e.bloomStr,Pt.streakStr=e.streakStr;for(let t=0;t<3;t++)Pt.tint[t]=e.tint[t];document.getElementById("tPreset").textContent=i.toUpperCase(),ho(".chip.pal","pal",i)}function gu(i){fe.lensing=i;let e=document.getElementById("btnLens");e.classList.toggle("on",i),e.setAttribute("aria-pressed",String(i))}function tc(i){fe.scienceMode=i;let e=document.getElementById("btnSci");e.classList.toggle("on",i),e.setAttribute("aria-pressed",String(i)),nc()}function _u(){fe.massIdx=(fe.massIdx+1)%rs.length,document.getElementById("btnMass").textContent=rs[fe.massIdx].label,nc()}var E0=document.getElementById("tRs"),w0=document.getElementById("tCam"),A0=document.getElementById("tTmax");function nc(){let{rsKm:i,tMaxK:e}=Ql(rs[fe.massIdx].msun),t=i/Zs;E0.textContent=i>=.01*Zs?(i/Zs).toFixed(2)+" AU ("+oo(i)+"km)":oo(i)+"km",A0.textContent=oo(e)+"K"}function oo(i){return i>=1e6?(i/1e6).toFixed(2)+"e6 ":i>=1e3?(i/1e3).toFixed(1)+"e3 ":i.toPrecision(3)+" "}function xu(i){fe.doppler=i;let e=document.getElementById("btnDopp");e.classList.toggle("on",i),e.setAttribute("aria-pressed",String(i))}function vu(i){fe.bloom=i;let e=document.getElementById("btnBloom");e.classList.toggle("on",i),e.setAttribute("aria-pressed",String(i))}function yu(){fe.paused=!fe.paused,document.getElementById("btnPause").textContent=fe.paused?"Resume":"Pause"}function Mu(i){document.getElementById("helpcard").classList.toggle("open",i),document.getElementById("btnHelp").setAttribute("aria-expanded",String(i))}function Su(){let i=document.getElementById("helpcard");Mu(!i.classList.contains("open"))}function bu(){fe.hudHidden=!fe.hudHidden,Jl.classList.toggle("hidden",fe.hudHidden),fe.hudHidden&&ru.classList.add("gone")}addEventListener("keydown",i=>{if(!i.repeat&&(os(),!((i.key===" "||i.key==="Enter")&&i.target instanceof HTMLButtonElement)))switch(i.key){case" ":i.preventDefault(),yu();break;case"1":ao("orbit"),Ks();break;case"2":ao("graze"),Ks();break;case"3":ao("overhead"),Ks();break;case"l":case"L":gu(!fe.lensing);break;case"d":case"D":xu(!fe.doppler);break;case"b":case"B":vu(!fe.bloom);break;case"p":case"P":ec(fe.palette==="ember"?"film":"ember");break;case"q":case"Q":T0();break;case"y":case"Y":tc(!fe.scienceMode);break;case"m":case"M":_u();break;case"h":case"H":bu();break;case"?":Su();break;case"Escape":Mu(!1);break}});matchMedia("(pointer: coarse)").matches||Et.addEventListener("dblclick",bu);bn.domElement.addEventListener("webglcontextlost",()=>{Mi.classList.remove("off"),Mi.querySelector(".msg-boot").innerHTML='<span class="label" style="color:var(--danger)">GPU context lost &mdash; recovering&hellip;</span>'});bn.domElement.addEventListener("webglcontextrestored",()=>location.reload());function Tu(){ru.classList.add("gone")}setTimeout(Tu,(bi+1.6)*1e3);var iu=performance.now(),er=0,ja=16,eo=0,kl=0,Xs=1/0,ts=1/0,su=0,to=0,Vl=0,no=0,C0=document.getElementById("tFps"),R0=document.getElementById("tRes"),I0=document.getElementById("tSteps");function P0(i){return i<.5?16*i*i*i*i*i:1-Math.pow(-2*i+2,5)/2}function L0(i){Le.idleTimer+=i;let e=as?0:1,t=!fe.paused&&Le.idleTimer>6?e:0;Le.autoBlend+=(t-Le.autoBlend)*(1-Math.exp(-i*1.4)),Le.autoBlend>.001&&!fe.paused&&(Le.tAz+=.052*i*Le.autoBlend);let n=Le.tDist,s=Le.tEl;if(Si<bi){Si+=i;let h=P0(js(Si/bi,0,1));n=26+(Le.tDist-26)*h,s=.55+(Le.tEl-.55)*h}let r=1-Math.exp(-i*6.5);Le.az+=(Le.tAz-Le.az)*r,Le.el+=(s-Le.el)*r,Le.dist+=(n-Le.dist)*r;let a=1+(as?0:.045*Math.sin(er*.043)),o=.028*Math.sin(er*.11)*Le.autoBlend*(fe.paused?0:1),c=js(Le.el+o,-1.35,1.35),l=Math.cos(c),u=Math.sin(c),p=Le.dist*a;en.position.set(p*l*Math.sin(Le.az),p*u,p*l*Math.cos(Le.az)),en.lookAt(0,0,0),en.updateMatrixWorld(!0)}var ns=new U,qs=new U,io=new U,D0=new U(0,1,0);function N0(){let i=cu[fe.qKey],e=so.uniforms;e.uTime.value=er,e.uCamPos.value.copy(en.position),window.__gargantua={camDist:Math.hypot(en.position.x,en.position.y,en.position.z),steps:i.steps,tier:fe.qKey,bloom:fe.bloom,hdr:$s!==bt},en.getWorldDirection(ns),qs.crossVectors(ns,D0).normalize(),io.crossVectors(qs,ns),e.uBasis.value.set(qs.x,io.x,ns.x,qs.y,io.y,ns.y,qs.z,io.z,ns.z),e.uTanF.value=Math.tan(dl.degToRad(en.fov/2)),e.uAspect.value=en.aspect,e.uSteps.value=i.steps,e.uDtScale.value=i.dt,e.uLensing.value=fe.lensing?1:0,e.uDoppler.value=fe.scienceMode?1:fe.doppler?it.doppler:0,e.uBeamExp.value=fe.scienceMode?4:3,e.uScience.value=fe.scienceMode?1:0,e.uDiskIn.value=fe.scienceMode?3:2.6,e.uTNorm.value=Ql(rs[fe.massIdx].msun).tMaxK/1e7,e.uGain.value=it.gain,e.uOpacity.value=.85,e.uFlow.value=.70711,e.uStars.value=S0?0:1,e.uTwinkle.value=as?.15:.6,e.uTint.value.set(it.tint[0],it.tint[1],it.tint[2])}function U0(i){let e=1-Math.exp(-i*2.4);it.gain+=(Pt.gain-it.gain)*e,it.doppler+=(Pt.doppler-it.doppler)*e,it.sat+=(Pt.sat-it.sat)*e,it.bloomStr+=(Pt.bloomStr-it.bloomStr)*e,it.streakStr+=(Pt.streakStr-it.streakStr)*e;for(let t=0;t<3;t++)it.tint[t]+=(Pt.tint[t]-it.tint[t])*e}function Eu(i){if(hu)return;requestAnimationFrame(Eu);let e=(i-iu)/1e3;if(iu=i,e>.05&&(e=.05),!(e>0))return;if(fe.paused||(er+=e),uu(),L0(e),U0(e),N0(),Jl.classList.toggle("dim",Le.idleTimer>8&&Si>=bi),Ws)so.uniforms.uJitter.value.set(0,0);else{let o=[];for(let l=0;l<16;l++){let u=(l+.5)*(Math.PI/8);o.push([Math.cos(u)*.375,Math.sin(u)*.375]);let p=u+.11;o.push([Math.cos(p)*1.5,Math.sin(p)*1.5])}let c=o[eo%32];so.uniforms.uJitter.value.set(c[0]/cn.width,c[1]/cn.height)}ni(so,cn);let t=Math.abs(Le.az-Le.tAz)+Math.abs(Le.el-Le.tEl)+Math.abs(Le.dist-Le.tDist)>1e-4,n=Math.abs(it.gain-Pt.gain)+Math.abs(it.sat-Pt.sat)+Math.abs(it.streakStr-Pt.streakStr)+Math.abs(it.doppler-Pt.doppler)>.002;Qa.uniforms.uCur.value=cn.texture,Qa.uniforms.uPrev.value=Dn.texture,Qa.uniforms.uMix.value=ql||Ws?1:!fe.paused||t||n?.5:.12,ni(Qa,Js);let s=Dn;if(Dn=Js,Js=s,ql=!1,fe.bloom){let o=Gl.uniforms;o.uSrc.value=Dn.texture,o.uTexel.value.set(1/cn.width,1/cn.height),ni(Gl,ss);let c=ss;for(let l of Nn)Ol.uniforms.uSrc.value=c.texture,Ol.uniforms.uTexel.value.set(1/c.width,1/c.height),ni(Ol,l.a),c=l.a;for(let l of Nn)ii.uniforms.uSrc.value=l.a.texture,ii.uniforms.uTexel.value.set(1/l.a.width,1/l.a.height),ii.uniforms.uDir.value.set(1,0),ni(ii,l.b),ii.uniforms.uSrc.value=l.b.texture,ii.uniforms.uTexel.value.set(1/l.b.width,1/l.b.height),ii.uniforms.uDir.value.set(0,1),ni(ii,l.a);Bl.uniforms.uSrc.value=Nn[0].a.texture,Bl.uniforms.uTexel.value.set(1/Nn[0].a.width,1/Nn[0].a.height),ni(Bl,co)}let r=jh.uniforms;r.uScene.value=Dn.texture;for(let o=0;o<5;o++)r["uB"+o].value=fe.bloom?Nn[o].a.texture:Dn.texture;r.uStreak.value=fe.bloom?co.texture:Dn.texture,r.uTime.value=er,r.uBloomStr.value=it.bloomStr,r.uStreakStr.value=it.streakStr,r.uExposure.value=1.05,r.uSaturation.value=fe.scienceMode?1:it.sat,r.uHasGlow.value=fe.bloom?1:0,r.uGrainAmt.value=M0||Ws||as?0:.03,r.uPinch.value=Ws?0:.045,r.uOutTexel.value.copy(Sn),ni(jh,null);let a=e*1e3;if(eo>20&&(ja+=(a-ja)*.08),Xs=Math.min(Xs,a),eo++,Vl++,no+=e,no>=.5){C0.textContent=Math.round(Vl/no)+" fps",Vl=0,no=0,R0.textContent=Math.round(fe.resScale*100)+"%",I0.textContent=cu[fe.qKey].steps+" steps";let{rsKm:o}=Ql(rs[fe.massIdx].msun),c=Le.dist,l=c*o;w0.textContent=c.toFixed(1)+" rs = "+(l>=.05*Zs?(l/Zs).toFixed(2)+" AU":oo(l)+"km")}if(fe.quality==="auto"&&!Ws&&(kl+=e,kl>=.8&&eo>40)){kl=0,ts=Math.min(ts*1.005,Xs),ts>0||(ts=Xs),Xs=1/0;let o=ja>Math.max(23,ts*1.55),c=ja<=ts*1.2+.4,l=o?-1:c?1:0;if(to=l!==0&&l===su?to+1:1,su=l,to>=2){to=1;let u=Ys.indexOf(fe.qKey),p=!1;l<0?fe.tierIdx>0?(fe.tierIdx--,p=!0):u>0&&(fe.qKey=Ys[u-1],fe.tierIdx=is.length-2,p=!0):l>0&&(fe.tierIdx<is.length-1?(fe.tierIdx++,p=!0):u>=0&&u<Ys.indexOf("high")&&(fe.qKey=Ys[u+1],p=!0)),p&&(fe.resScale=is[fe.tierIdx],tr(!1))}}}ec("ember");ho(".chip.qual","q",fe.quality);document.getElementById("btnMass").textContent="M "+rs[fe.massIdx].label;tc(fe.scienceMode);nc();jl();tr(!0);Mi.classList.add("off");requestAnimationFrame(Eu);})();
